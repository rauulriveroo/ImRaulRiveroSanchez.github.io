    ...
    <header class="header">
        <div class="container">
            ...
            <div class="header-content">
                ...
                <h1 class="header-title">Raúl Rivero</h1>
                <h6 class="header-mono" >Data Engineer | Developer</h6>
        ...
        <div class="container">
            ...
            <div class="collapse mt-sm-20 navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav brand">
                    ...
                    <li class="brand-txt">
                        <h5 class="brand-title">Raúl Rivero</h5>
                        <div class="brand-subtitle">Data Scientist| Developer</div>
                    </li>
                </ul>
    ...
    <div class="container-fluid">
        <div id="about" class="row about-section">
            <div class="col-lg-4 about-card">
                ...
                <h5 class="mb-3">A Data Engineer/ Developer Located In Our Lovely Earth</h5>
                <p class="mt-20">I am a talented, ambitious and hardworking individual, with broad skills and experience in digital and printed marketing, social media and leading projects. Furthermore, I am adept at handling multiple tasks on a daily basis competently and at working well under pressure. </p>
            ...
            <div class="col-lg-4 about-card">
                ...
                <ul class="mt40 info list-unstyled">
                    <li><span>Birthdate</span> : 16/10/2004</li>
                    <li><span>Email</span> : rauulriveroo@gmail.com</li>
                    <li><span>Phone</span> : +34 687734162</li>
                    <li><span>Instagram</span> : @rauullriveroo </li>
                    <li><span>Address</span> :  35330 Av Santiago de Cuba/1.</li>
                </ul>
                <ul class="social-icons pt-3">
                    ...
                    <div class="card">
                       <div class="card-header">
                        ...
                        <div class="card-body">
                            ...
                            <P>Studying data engineering</P>
                            <P class="subtitle">i'm studying data engineering at University of Las Palmas de Gran Canaria.</P>
                            <hr>
                            <h6 class="title text-danger">2020 - 2021</h6>
                            <P>Bachelor's degree</P>
                            <P class="subtitle">I got my Bachelor's degree at IES Teror.</P>
                            <hr>
                            <h6 class="title text-danger">2017 - 2018</h6>
                            <P>ESO Degree</P>
                            <P class="subtitle">I got my ESO's degree at IES Teror, which I finished in 3 years.</P>
                ...
                <div class="col-lg-4">
                    <div class="contact-info-card">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-10 ">
                                <h6 class="d-inline">Phone : <br> <span class="text-muted">+34 687734162</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Address :<br> <span class="text-muted">35330 Av Santiago de Cuba/1.</span></h6>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-1 pt-1 mr-1">
                            ...
                            <div class="col-10">
                                <h6 class="d-inline">Email :<br> <span class="text-muted">rauulriveroo@gmail.com</span></h6>
                            </div>
                        </div>
